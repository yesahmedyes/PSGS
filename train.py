...
def training(
    ...
    # PGGS: Track running averages for current phase
    phase_ssim_losses = []
    phase_l1_losses = []
    ...
    for iteration in range(first_iter, opt.iterations + 1):
            ...
            if phase_counter % pggs_config.update_frequency == 0:
                ...
                with torch.no_grad():
                    ...
                    if tb_writer:
                        ...
                        tb_writer.add_scalar("pggs/avg_l1_loss", avg_l1_loss, iteration)
                        tb_writer.add_scalar(
        ...
        # PGGS: Track losses for current phase
        if pggs_config.use_pggs:
