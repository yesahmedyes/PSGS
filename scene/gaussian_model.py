    ...
    def training_setup(self, training_args):
        ...
        l = [
            ...
            },
            {
                ...
                "base_lr": training_args.feature_lr,
                "lr_scale": 1.0,
                "name": "f_dc",
            },
            {
                ...
                "base_lr": training_args.feature_lr / 20.0,
                "lr_scale": 1.0,
                "name": "f_rest",
            },
            {
            ...
            },
            {
                ...
                "base_lr": training_args.scaling_lr,
                "lr_scale": 1.0,
                "name": "scaling",
            },
            {
                ...
                "base_lr": training_args.rotation_lr,
                "lr_scale": 1.0,
                "name": "rotation",
            },
        ]
    ...
    def update_learning_rate(self, iteration):
        ...
        for param_group in self.optimizer.param_groups:
            if param_group["name"] == "pose":
                ...
                base_lr = param_group.get("base_lr", 0.0)
